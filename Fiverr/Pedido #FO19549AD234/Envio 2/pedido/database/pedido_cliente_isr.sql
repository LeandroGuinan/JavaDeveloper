...
CREATE TABLE `isr` (
  ...
  `tipo_isr` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`id_ISR`)
...
INSERT INTO `isr` VALUES (21,'trimestral'),(22,'trimestral'),(23,'mensual'),(24,'mensual'),(25,'mensual'),(26,'mensual'),(30,'trimestral');
