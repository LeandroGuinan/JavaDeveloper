...
public class Inicio extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        usuarioEntrante = us.logIn(usuario, contraseña);
        if (usuarioEntrante != null) {
            menu me = new menu();
            menu.etiquetaUsuario.setText("Bienvenido Usuario: " + usuarioEntrante.getNombreUsuario());
            menu.etiquetaRol.setText("Rol: "+usuarioEntrante.getIdRol().getTipoRol());
            menu.usuario = usuarioEntrante;
            if(usuarioEntrante.getIdRol().getIdRol() != 1){
