...
CREATE TABLE `cliente` (
  ...
  CONSTRAINT `id_contacto` FOREIGN KEY (`id_contacto`) REFERENCES `contacto` (`id_contacto`),
  ...
  CONSTRAINT `id_isr` FOREIGN KEY (`id_isr`) REFERENCES `isr` (`id_ISR`)
...
INSERT INTO `cliente` VALUES (29,28,16,22,'sofia','vergara',789,'987',20,28,28),(31,30,18,24,'sofia','perez',788,'988',20,30,30),(36,35,23,29,'jose','gomez',18616,'81318',20,35,35);
