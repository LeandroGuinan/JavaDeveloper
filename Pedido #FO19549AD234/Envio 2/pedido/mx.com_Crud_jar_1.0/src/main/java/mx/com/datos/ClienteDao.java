...
public class ClienteDao {
    ...
    public void insertarCliente(Cliente cliente) {
        try {
            ...
            JOptionPane.showMessageDialog(null, "NIT o CUI ya existentes", "No Completado", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    public void reiniciarContadorClientes() {
        em.getTransaction().begin();
        em.createNativeQuery("TRUNCATE cliente").executeUpdate();
        em.getTransaction().commit();
    }
}
