 ...
 * @author guina
 */
public class ExportarForm extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        cliente.imprimirClientePdf();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        ClienteService cliente = new ClienteService();
        cliente.imprimirClienteExcel();
    ...
    public static void NotMain(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ExportarForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ExportarForm().setVisible(true);
            }
        });
    }
