...
public class Empleado implements Serializable {
    ...
    public Empleado(String nombre, String apellido, String sueldo, Persona persona) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Empleado{" + "idEmpleado=" + idEmpleado + ", nombre=" + nombre + ", apellido=" + apellido + ", sueldo=" + sueldo + '}';
    }
