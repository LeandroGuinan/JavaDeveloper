...
public class Administracion implements Serializable {
    ...
    public Administracion(String nombre, String apellido, String sueldo, String usuario, String password, Empleado empleado) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Administracion{" + "idAdmin=" + idAdmin + ", nombre=" + nombre + ", apellido=" + apellido + ", sueldo=" + sueldo + ", usuario=" + usuario + ", password=" + password + '}';
    }
