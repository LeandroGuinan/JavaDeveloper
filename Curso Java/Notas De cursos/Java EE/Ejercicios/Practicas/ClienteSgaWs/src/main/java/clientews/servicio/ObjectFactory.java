...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonaResponse_QNAME = new QName("http://servicio.sga.gm.com.it/", "listarPersonaResponse");
    private final static QName _ListarPersona_QNAME = new QName("http://servicio.sga.gm.com.it/", "listarPersona");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.gm.com.it/", name = "listarPersonaResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.gm.com.it/", name = "listarPersona")
