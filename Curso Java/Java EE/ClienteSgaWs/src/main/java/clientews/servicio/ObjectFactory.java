...
public class ObjectFactory {
    ...
    private final static QName _ListarPersonas_QNAME = new QName("http://servicio.sga.gm.com.it/", "listarPersonas");
    private final static QName _ListarPersonasResponse_QNAME = new QName("http://servicio.sga.gm.com.it/", "listarPersonasResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.gm.com.it/", name = "listarPersonas")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://servicio.sga.gm.com.it/", name = "listarPersonasResponse")
