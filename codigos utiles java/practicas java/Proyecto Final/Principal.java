...
public class Principal extends JFrame implements ActionListener{
  ...
  private JMenuItem miCalculo, miNegro, miRojo, miMorado, miElCreador, miSalir, miNuevo;
  private JLabel labelLogo, labelBienvenido, labelTittle, labelNombre, labelAPaterno, labelAMaterno,
                 labelDepartamento, labelAntiguedad, labelResultado, labelfoother;
  private JTextField txtNombreDelTrabajador, txtAPaternoTrabajador, txtAMaternoTrabajador;
  ...
  public Principal(){
   ...
   labelTittle = new JLabel("Datos Del Trabajador Para El Calculo De Vacaciones");
   labelTittle.setBounds(45,140,900,25);
   labelTittle.setFont(new Font("Andale Mono", 0, 24));
   labelTittle.setForeground(new Color(255,255,255));
   add(labelTittle);
   ...
   txtNombreDelTrabajador = new JTextField();
   txtNombreDelTrabajador.setBounds(25,213,150,25);
   txtNombreDelTrabajador.setBackground(new java.awt.Color(224,224,224));
   txtNombreDelTrabajador.setFont(new java.awt.Font("Andale Mono", 1, 14));
   txtNombreDelTrabajador.setForeground(new java.awt.Color(255,0,0));
   add(txtNombreDelTrabajador);
   ...
   comboAntiguedad.addItem("7 Anos De Servicio o Mas");
   ...
   labelfoother = new JLabel("©2017 the Coca-Cola Company | Todos los derechos reservados");
   labelfoother.setBounds(135,445,500,30);
   labelfoother.setFont(new java.awt.Font("Andale Mono", 1, 12));
   labelfoother.setForeground(new java.awt.Color(255,255,255));
   add(labelfoother);  
 }
   ...
   public void actionPerformed(ActionEvent eve){
    ...
    if(eve.getSource() == miCalculo){
     ...
     String nombreTrabajador = txtNombreDelTrabajador.getText();
    ...
    if(Departamento.equals("Atencion Al Cliente")){
      ...
      if(Antiguedad.equals("7 Anos De Servicio o Mas")){
       textarea1.setText("\n  El Trabajador "+ nombreTrabajador +" " + AP + " " + AM +
                        "\n  quien labora en " + Departamento + " con" + Antiguedad +
   ...
   this.setVisible(false);
    ...
    JOptionPane.showMessageDialog(null,"Desarrollado por Leandro David Guinan");
  }
 }
